...
// API Proxmox
define('PMG_HOST', 'https://pmg.seudominio.com.br:8006');
define('PMG_USER', 'root@pam');
define('PMG_PASS', 'senhadorootpmg');

// Configurações SMTP
define('SMTP_HOST', 'smtp.seuprovedor.com');
define('SMTP_PORT', 587);
define('SMTP_USER', 'seuemail@dominio.com');
define('SMTP_PASS', 'suasenha');
define('SMTP_ENCRYPTION', 'tls');
define('SMTP_FROM_EMAIL', 'naoresponda@seudominio.com');
define('SMTP_FROM_NAME', 'Rastreador PMG');
